...
INCLUDES += -I.
INCLUDES += -I./Adafruit_GFX_Library
INCLUDES += -I./Adafruit_ST7735_and_ST7789_Library
INCLUDES += -I./SPI
...
MYSRCFILES += $(shell ls SPI/*.cpp 2>/dev/null)
MYSRCFILES += $(shell ls Adafruit_GFX_Library/*.cpp 2>/dev/null)
MYSRCFILES += $(shell ls Adafruit_ST7735_and_ST7789_Library/*.cpp 2>/dev/null)
